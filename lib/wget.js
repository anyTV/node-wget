    ...
    req = request(
        ...
        function(res) {
            ...
            if (
                ...
                res.statusCode === HTTP_STATUS.MOVED_TEMPORARILY ||
                res.statusCode === HTTP_STATUS.TEMPORARY_REDIRECT
            ) {
            ...
            if (res.statusCode === HTTP_STATUS.OK || res.statusCode === HTTP_STATUS.PARTIAL_CONTENT) {
                downloadedSize = 0;
                ...
                const flags = res.statusCode === HTTP_STATUS.PARTIAL_CONTENT ? 'a' : 'w+';
